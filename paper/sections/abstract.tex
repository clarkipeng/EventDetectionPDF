...
A common shortcut trains samplewise segmentation masks and derives event times only after thresholding or transition detection, creating a mismatch when evaluation ranks temporal detections rather than labels at every sample.
