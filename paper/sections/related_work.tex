...
The question is what loss should be attached to such sequence predictors when the benchmark consumes detections.
...
These methods motivate moving supervision toward the times that will be detected, but a proximity target alone does not specify what the output should estimate after the recording is windowed, smoothed, or downsampled.
