...
On sleep-event detection, the gains are largest at strict onset and wake-up
tolerances, persist across recurrent and convolutional backbones, and are not
recovered by class weighting, focal loss, or smoothing alone.
...
Future work should study stronger structured decoders for paired endpoints,
calibrated online variants, and broader health benchmarks where objective,
architecture, and post-processing choices can be separated more fully.
