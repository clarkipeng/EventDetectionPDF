...
\caption{Held-out sleep window on a shared time axis.  Dashed lines mark the
annotated onset and wake-up.  Segmentation predicts a state interval and
derives boundary scores afterward; BDL directly scores the endpoint events
matched by event AP.}
