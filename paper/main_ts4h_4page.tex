...
BDL is also narrower than a temporal point process.
It does not model censoring, mark dynamics, or clinical event generation.
Its contribution is to give localized boundary supervision a likelihood and a
unit: expected scored events per output bin.
