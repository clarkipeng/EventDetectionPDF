...
U-Net.
A paired fold check gives the same direction on all 36 matched sleep
seed--fold comparisons across these three backbones, and on all eight
available CHB-MIT folds for the two high-capacity stride rows.
